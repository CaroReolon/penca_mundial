...
ActiveRecord::Schema[7.1].define(version: 2026_06_26_030000) do
  ...
  create_table "highlights", force: :cascade do |t|
    ...
    t.index ["play_group_id"], name: "index_highlights_on_play_group_id"
  ...
  add_foreign_key "highlights", "play_groups"
